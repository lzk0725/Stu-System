                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="score.php">成绩信息</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><a href='insertscore.php'><i class='fa fa-paint-brush'>录入学生成绩</i></a></div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover"
                                ...
                                $lineStyle = $line%2==1?"odd gradeX":"even gradeC";
                                    ...
                                    echo "<td>" . $row ['km'] . "</td>";
                                    echo "<td>" . $row ['cj'] . "</td>";
                                    echo "<td><a class='btn btn-primary btn-sm shiny' href=\"editscore.php?id='". $row ['id'] ."'\"'><i class='fa fa-edit'>&nbsp;编辑</i></a>&nbsp;&nbsp;<a class='btn btn-danger btn-sm shiny' href=\"deletescore.php?id='". $row ['id'] ."'\"'><i class='fa fa-trash-o'>&nbsp;删除</i></a></td>";
                                    echo "</tr>";
                                }
                                ?>
                                </tbody>
