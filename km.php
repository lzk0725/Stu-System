    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <div class="row">
				...
				<div class="panel-heading"><a href='insertkm.php'><i class='fa fa-paint-brush'>录入科目</i></a></div>
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover"
								...
								$lineStyle = $line%2==1?"odd gradeX":"even gradeC";
								    ...
								    echo  "<td><a class='btn btn-primary btn-sm shiny' href=\"kmdo.php?id='". $row ['id'] ."'\"'><i class='fa fa-edit'>&nbsp;科目成绩</i></a><a class='btn btn-danger btn-sm shiny' href=\"deletekm.php?id='". $row ['id'] ."'\"'><i class='fa fa-trash-o'>&nbsp;删除</i></a></td>";
									echo "</tr>";
									echo "</tr>";
								}
								?>
